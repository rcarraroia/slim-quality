...
## Repository map
- `agent/` — explain what lives here and when agents should edit it.
- `agent.zip/` — explain what lives here and when agents should edit it.
- `api/` — explain what lives here and when agents should edit it.
- `backups/` — explain what lives here and when agents should edit it.
- `BUGS_SISTEMA_AFILIADOS/` — explain what lives here and when agents should edit it.
