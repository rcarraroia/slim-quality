...
function generateSmartResponse(message) {
  ...
  // Resposta padrão
  return "Obrigada pela sua mensagem! Sou a BIA da Slim Quality. Nossos colchões magnéticos terapêuticos podem ajudar com diversos problemas de saúde como dores, má circulação e problemas de sono. Para um atendimento mais personalizado, entre em contato pelo WhatsApp: (33) 99838-4177. Como posso ajudar você hoje?";
}